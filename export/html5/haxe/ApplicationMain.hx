...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("PixelDay2019", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("PixelDay2019", null, 640, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "PixelDay2019";
		app.meta["name"] = "PixelDay2019";
